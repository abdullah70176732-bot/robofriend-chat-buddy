...
import {
  ...
  Sparkles, Zap, Rocket, Bot, CheckCircle2, Circle, Menu, X,
  Palette, Globe, Plus, MessageSquare, Wand2, Gamepad2, Trophy, Award,
  BarChart3, ImagePlus, Brain, Square,
} from "lucide-react";
import { RoboSVG, RoboAvatar } from "@/components/nexus/RoboSVG";
import {
  SESSIONS_KEY, ACTIVE_KEY, THEME_KEY, LANG_KEY, CUSTOM_KEY, ACH_KEY, STATS_KEY,
  MEMORY_KEY, PRODUCTIVITY_KEY,
  THEMES, LANGUAGES, BODY_COLORS, EYES, HATS, ACHIEVEMENTS, MOODS, QUESTS,
} from "@/lib/nexus/constants";
import type {
  Msg, Sentiment, Mood, Session, EyeStyle, Hat, Customization, RPSChoice,
  Achievement, Memory, ProductivityDay,
} from "@/lib/nexus/types";
import {
  classifySentiment, extractPreferences, todayKey, buildMemoryContext,
} from "@/lib/nexus/memory";
